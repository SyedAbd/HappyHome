...
public class DialogueManager : MonoBehaviour
{
    ...
    void OnClickChoiceButton(Choice choice)
    {
        ...
        if (choice.text.Contains("You hear your dad calling for you") || choice.text.Contains("Living Room") || choice.text.Contains("Enjoy the show") || choice.text.Contains("What happened?"))
        {
